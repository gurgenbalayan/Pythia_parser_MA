# Проект Pythia Parser Massachusetts
...
После установки всех зависимостей и настройки переменных окружения, запускаем скрипт `Pythia_parser_MA.py`:

```bash
python Pythia_parser_MA.py
```
